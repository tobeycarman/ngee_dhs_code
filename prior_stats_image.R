...
# https://github.com/PecanProject/bety/blob/develop/script/previewhelp.R
# which is the script that is used to create the little preview thumbnail images
# for each prior that shows up in the bety web interface.

# For these purposes, I need to be able to optionally turn off the image creation
# and to get the mean and 95% confidence interval bounds output to text for 
# inclusion in a table for the manuscript.
